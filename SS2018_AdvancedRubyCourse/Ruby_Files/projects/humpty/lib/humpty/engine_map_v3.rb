class Engine 
    ...
    def play(current_scene = nil, scene_choices = {Title => nil, Start => nil, Wall => nil, Fall => nil, Credits => nil, GameOver => nil})
      ...
      until current_scene.is_a?(GameOver) || current_scene.is_a?(Credits)
        choice_accessor = scene_choices[current_scene.class.name]
        puts choice_accessor
        current_scene = @scene_map.scene_returner(current_scene.enter(choice_accessor))
      end
