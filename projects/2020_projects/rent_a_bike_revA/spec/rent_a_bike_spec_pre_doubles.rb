...
describe DockingStation do 
    ...
    describe '#release_bike' do
        ...
        it 'skips broken bikes' do 
            test_bikes = [Bike.new, Bike.new('Flat Tyre'),Bike.new('Damaged Wheel'), Bike.new]
        ...
        it 'raises exception when only broken bikes available' do
            subject.dock_bike(Bike.new('Brakes Faulty'))
    ...
    describe '#dock_bike' do
        ...
        it 'assigns docked bikes to an array' do
            test_docked_bike = Bike.new
            test_docked_bike_2 = Bike.new
...
describe User do
    ...
    describe '#hire_bike' do
        ...
        it 'user accepts released bike from dock' do
            test_dock_2 = DockingStation.new
            test_bike_3 = Bike.new
            test_dock_2.dock_bike(test_bike_3)
    ...
    describe '#return_bike' do
        ...
        it 'user returns bike to dock' do
            test_dock_3 = DockingStation.new
            test_bike_4 = Bike.new
        ...
        it 'raises exception when the user does not have a bike to return' do
            expect{User.new('Greg)').return_bike(DockingStation.new)}.to raise_error 'No Bikes Currently Under Hire'
        end  
    end
end
